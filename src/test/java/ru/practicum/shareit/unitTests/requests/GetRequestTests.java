...
public class GetRequestTests {
    ...
    @Test
    void getItemRequest_WithCorrectParams_ReturnsCorrectResponse() {
        ...
        Mockito
                .when(itemRequestRepository.getRequests(Mockito.anyLong()))
        ...
        // Act
        var actualRequests = itemRequestService.get(user.getId());
    ...
    @Test
    void getItemRequest_WithNotExistingUser_ShouldThrowException() {
